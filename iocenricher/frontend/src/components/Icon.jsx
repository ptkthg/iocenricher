// Biblioteca de ícones SVG inline — todos no mesmo viewBox 24x24
...
const ICONS = {
  ...
  reports: <><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" /><path d="M14 2v6h6M9 13h6M9 17h6" /></>,
  ...
  biohazard: <><circle cx="12" cy="12" r="2" /><circle cx="12" cy="6" r="2.5" /><circle cx="6.5" cy="16" r="2.5" /><circle cx="17.5" cy="16" r="2.5" /></>,
  ...
  wifiOff: <><line x1="1" y1="1" x2="23" y2="23" /><path d="M16.72 11.06A10.94 10.94 0 0119 12.55" /><path d="M5 12.55a10.94 10.94 0 015.17-2.39" /><path d="M10.71 5.05A16 16 0 0122.58 9" /><path d="M1.42 9a15.91 15.91 0 014.7-2.88" /><path d="M8.53 16.11a6 6 0 016.95 0" /><line x1="12" y1="20" x2="12.01" y2="20" /></>,
  ...
  bookmarkSaved: <path d="M19 21l-7-5-7 5V5a2 2 0 012-2h10a2 2 0 012 2z" />,
